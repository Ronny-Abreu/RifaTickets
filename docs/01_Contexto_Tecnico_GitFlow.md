...
* **Fase 2 (Completada):** Documentación del Plan de Pruebas, archivos Markdown y configuración de repositorio (2 horas).
* **Fase 3 (En Curso - Viernes):** Desarrollo de vistas públicas y conexión con Firebase Auth/Firestore (2 horas).
* **Fase 4:** Desarrollo del Dashboard de Administrador y validación de comprobantes (2 horas).
* **Fase 5:** Automatización de pruebas con Selenium e integración a la rama QA (4 horas).
* **Fase 6:** Pruebas E2E manuales en `main`, grabación de video de incremento y entrega (14 horas disponibles).

## Estructura de carpetas
* **src/**
  * **components/** (Aquí irán los componentes de UI, ej. LoginForm)
  * **styles/** (Aquí irán todos los archivos .css puros, separados por componente o vista)
  * **pages/** (Vistas principales: Login, Dashboard, Home)
  * **config/** (Archivo firebaseConfig.js para la conexión a la base de datos).